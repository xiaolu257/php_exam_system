  ...
  >
    ...
    <el-table-column align="center" fixed="right" label="操作" width="200">
      <template #default="scope">
        <el-button v-if="controllerVisible(scope.row)" size="small" type="primary"
                   @click="controllerFunction(scope.row,refreshTableData)">
          {{ controllerName }}
        </el-button>
      </template>
    </el-table-column>
...
interface Props {
  ...
  controllerVisible: (status: any) => boolean;
  controllerFunction: (data: any, borrowBookSuccess: Function) => void;
